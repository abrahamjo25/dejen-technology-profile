        ...
        <div className="row gy-4">
          <div className="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
            <div className="content px-xl-5" data-aos-delay={100}>
              ...
              <p>
                Our Company have diverse set of technical and non-technical
                skills to excel in delivering quality solutions. Below is a
                categorized list of key skills:
              </p>
            </div>
            <div className="faq-container px-xl-5" data-aos-delay={200}>
              ...
              <div className="faq-item">
                <h3>
                  <span>02</span> Design and User Experience
                </h3>
                <div className="faq-content">
                  <p>
                    {" "}
                    <ul>
                      <li>
                        <i className="bi bi-check2-circle" />{" "}
                        <span>
                          UI/UX Design: Creating user-friendly and intuitive
                          interfaces.
                        </span>
                      </li>
                      <li>
                        <i className="bi bi-check2-circle" />{" "}
                        <span>
                          Graphic Design: For branding, logos, and visuals.
                        </span>
                      </li>
                      <li>
                        <i className="bi bi-check2-circle" />{" "}
                        <span>Prototyping Tools: Figma, Adobe XD, Sketch.</span>
                      </li>
                    </ul>{" "}
                  </p>
                </div>
              ...
              <div className="faq-item">
                <h3>
                  <span>03</span> Business and Project Management Skills
                </h3>
                <div className="faq-content">
                  <p>
                    {" "}
